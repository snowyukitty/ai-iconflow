...
IconFlow reviews design work, and design review is judgement about someone's
craft. Critique the mark, the geometry, and the evidence — never the person who
drew it. A review that says "distinctiveness reads 3/5 because the silhouette
names a generic tile at 16px" is useful. One that says "this is amateur work" is
not, and is not welcome here.
...
IconFlow is currently maintained by one person, and the private channel this
repository has is GitHub's security advisory form. Report abusive, harassing, or
otherwise unacceptable behavior there:

**<https://github.com/snowyukitty/ai-iconflow/security/advisories/new>**

It is nominally for vulnerabilities, but it is private, it reaches the
maintainer, and using it for a conduct report is expected and appropriate. Say
in the first line that the report concerns conduct rather than a vulnerability.
A dedicated contact will replace this if the project grows enough to need one.
