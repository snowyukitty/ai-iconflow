...
date: 2026-08-12
project: Wooden Clothespin
targets: web
essence: hold
style_family: flat-geometric
signature_device: A 228-unit coral spring chamber separates the two wooden jaws.
device_family: object-silhouette
device_detail: A 228-unit coral spring chamber separates the two wooden jaws.
concept_lens: specific-object
cliche_avoided: a washing machine drum
status: shipped
...
## Summary
Wooden Clothespin serves the job “secure family laundry on a line in changing weather”. The selected clothespin direction won because its silhouette stays specific while A 228-unit coral spring chamber separates the two wooden jaws. carries the single signature device.
...
- [x] At 16px, preserve the clothespin before medium-specific detail; the winning lens was Object lens: a side-view wooden peg with split jaws.
