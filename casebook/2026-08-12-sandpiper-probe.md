---
slug: sandpiper-probe
date: 2026-08-12
project: Sandpiper probing shore
targets: web
essence: probe
style_family: woodcut
signature_device: long offset probing bill
device_family: negative-space-cut
device_detail: long offset probing bill
concept_lens: specific-object
cliche_avoided: generic shorebird
status: shipped
...
## Summary
Sandpiper probing shore serves the job “sample”. The selected sandpiper direction won because its silhouette stays specific while long offset probing bill carries the single signature device.
...
- [x] At 16px, preserve the sandpiper before medium-specific detail; the winning lens was Object: sandpiper bending to shore
