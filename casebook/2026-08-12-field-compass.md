...
slug: field-compass
date: 2026-08-12
project: Field compass
targets: web
essence: bearing
style_family: chrome
signature_device: off-axis needle
device_family: object-silhouette
device_detail: off-axis needle
concept_lens: specific-object
cliche_avoided: generic target
status: shipped
...
## Summary
Field compass serves the job “orient”. The selected field compass direction won because its silhouette stays specific while off-axis needle carries the single signature device.
...
- [x] At 16px, preserve the field compass before medium-specific detail; the winning lens was Object: survey compass face
