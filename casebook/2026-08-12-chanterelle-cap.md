---
slug: chanterelle-cap
date: 2026-08-12
project: Chanterelle mushroom
targets: web
essence: earth
style_family: cel-shaded
signature_device: folded cap edge
device_family: object-silhouette
device_detail: folded cap edge
concept_lens: specific-object
cliche_avoided: generic mushroom
status: shipped
...
## Summary
Chanterelle mushroom serves the job “forage”. The selected chanterelle direction won because its silhouette stays specific while folded cap edge carries the single signature device.
...
- [x] At 16px, preserve the chanterelle before medium-specific detail; the winning lens was Object: chanterelle with stem
