---
slug: social-signal-interest-forums
date: 2026-08-12
project: Topic Drawer
targets: web study
essence: discussion
style_family: chrome
signature_device: a broad specular band stops at the inset topic label
device_family: object-silhouette
device_detail: a broad specular band stops at the inset topic label
concept_lens: clean-room-user-job
cliche_avoided: alien mascots, antennae, orange conversation marks
status: reviewed
...
## Summary
Topic Drawer translates the generic job 'Discuss topics in interest-led forums with durable context.' into an original card-catalog drawer without vendor geometry or trade dress.
...
- [x] At 16px, the card-catalog drawer needs its structural a broad specular band stops at the inset topic label before material detail.
